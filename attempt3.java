    ...
    public static void main(String args[]) throws Exception
    {
        ...
        while(reader0.hasNextLine())
        {
            ...
            while(i<st.length())
            {
                ...
                else if(data0[i]=='\'' && data0[i-1]!='\\')
                {
                    if(singlequotes==0)
                    {
                   singlequotes++; 
                    }
                   /* else if(singlequotes==1)
                    {
                        
                        while(singlequotes!=2)
                        {
            ...
            else if(st.startsWith("printf(") || st.startsWith("printf "))
             {
              ...
              // System.out.print(temp);
               ...
               else if(temp.contains("(") && temp.contains(")"))
               {
                ...
                int start8=0;
                int end8=0;
                int length8=temp.length();
                while(ind8<length8)
                {
                    if(bracketremover[ind8]=='(')
                    {
                        bracket8++;
                    }
                    else if(bracketremover[ind8]==')')
                    {
                        bracket8--;
                    }
                    if(bracket8==0 && bracketremover[ind8]==',')
                    {
                        bracketremover[ind8]='#';
                    }
                    ind8++;
